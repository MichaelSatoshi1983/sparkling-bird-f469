...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/sparkling-bird-f469)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/sparkling-bird-f469
```

A live public deployment of this template is available at [https://sparkling-bird-f469.templates.workers.dev](https://sparkling-bird-f469.templates.workers.dev)
